...
from config import BOT_TOKEN, API_ID, API_HASH, ADMIN_IDS, TEMP_DIR
    ...
    if state == "AWAITING_FILE_RENAME":
        ...
        try:
            ...
            if res.get("status") == "success":
                ...
                download_url = f_data.get("download_url") or f"https://tgdriveapi.youganksaini1.workers.dev/v1/files/{file_id}/download"
